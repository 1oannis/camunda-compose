#!/bin/sh
#
# ident "@(#)$Id: 99-Entrypoint_of_keycloak.sh | Sat Nov 18 22:55:00 2023 +0100 | UnknownUser @ MacBook-Air-GS-6.local  $"
...
do
   ...
   #
   /opt/keycloak/bin/kc.sh start --optimized >/dev/stderr
   #
   # Print a warning
   #
   echo "###################################################################" >/dev/stderr
...
exit 1
#
# end-of-99-Entrypoint_of_keycloak.sh
#
