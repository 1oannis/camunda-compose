#!/bin/sh -x
#
# ident "@(#)$Id: docker-healthcheck.sh | Sat Nov 18 21:52:15 2023 +0100 | UnknownUser @ MacBook-Air-GS-6.local  $"
...
###
# 
# Define the number of expected HTTP daemons
#
NUM_OF_SERVICES=5
# 
...
exit $?
#
# end-of-container/docker-config/docker-healthcheck.sh
#
